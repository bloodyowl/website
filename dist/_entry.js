...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/App.bs.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/bs-css-emotion/src/Css.bs.js":
/*!***************************************************!*\
  !*** ./node_modules/bs-css-emotion/src/Css.bs.js ***!
  \***************************************************/
...
var Css_Legacy_Core = __webpack_require__(/*! bs-css/src/Css_Legacy_Core.bs.js */ "./node_modules/bs-css/src/Css_Legacy_Core.bs.js");
...
/***/ "./node_modules/bs-css/src/Css_Legacy_Core.bs.js":
/*!*******************************************************!*\
  !*** ./node_modules/bs-css/src/Css_Legacy_Core.bs.js ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./node_modules/rescript-pages/src/Pages.bs.js":
/*!*****************************************************!*\
  !*** ./node_modules/rescript-pages/src/Pages.bs.js ***!
  \*****************************************************/
/*! no static exports found */
...
function useUrl(param) {
  ...
  return {
          path: stripInitialPath(url.path, pathParse("/")),
          hash: url.hash,
          search: url.search
        };
}
...
function useCollection(pageOpt, directionOpt, collection) {
  ...
  React.useEffect((function () {
          ...
          var url = "/api/" + collection + "/pages/" + direction + "/" + String(page) + ".json";
...
function useItem(collection, id) {
  ...
  React.useEffect((function () {
          ...
          var url = "/api/" + collection + "/items/" + id + ".json";
          var future = Future.mapResult(Future.mapError($$Request.make(url, undefined, /* Text */0, undefined, undefined, undefined, undefined, undefined, undefined, undefined), true, mapError), true, (function (response) {
                  if (!response.ok) {
                    return {
                            TAG: /* Error */1,
...
var Home = __webpack_require__(/*! ./pages/Home.bs.js */ "./src/pages/Home.bs.js");
var Curry = __webpack_require__(/*! bs-platform/lib/js/curry.js */ "./node_modules/bs-platform/lib/js/curry.js");
var Pages = __webpack_require__(/*! rescript-pages/src/Pages.bs.js */ "./node_modules/rescript-pages/src/Pages.bs.js");
var React = __webpack_require__(/*! react */ "react");
var Footer = __webpack_require__(/*! ./shared/Footer.bs.js */ "./src/shared/Footer.bs.js");
var Header = __webpack_require__(/*! ./shared/Header.bs.js */ "./src/shared/Header.bs.js");
var $$String = __webpack_require__(/*! bs-platform/lib/js/string.js */ "./node_modules/bs-platform/lib/js/string.js");
var BlogPost = __webpack_require__(/*! ./pages/BlogPost.bs.js */ "./src/pages/BlogPost.bs.js");
var CssReset = __webpack_require__(/*! ./utils/CssReset.bs.js */ "./src/utils/CssReset.bs.js");
var Belt_Array = __webpack_require__(/*! bs-platform/lib/js/belt_Array.js */ "./node_modules/bs-platform/lib/js/belt_Array.js");
var BlogPostList = __webpack_require__(/*! ./pages/BlogPostList.bs.js */ "./src/pages/BlogPostList.bs.js");
var ErrorIndicator = __webpack_require__(/*! ./shared/ErrorIndicator.bs.js */ "./src/shared/ErrorIndicator.bs.js");
...
function App(Props) {
  var url = Props.url;
  var config = Props.config;
  var url$1 = config.baseUrl + ("/" + $$String.concat("/", url.path));
  var match = url.path;
  var tmp;
  if (match) {
    if (match.hd === "blog") {
      var match$1 = match.tl;
      tmp = match$1 ? (
          match$1.tl ? React.createElement(ErrorIndicator.make, {}) : React.createElement(BlogPost.make, {
                  slug: match$1.hd
                })
        ) : React.createElement(BlogPostList.make, {});
    } else {
      tmp = React.createElement(ErrorIndicator.make, {});
    }
  } else {
...
var $$default = Pages.make(App, {
      ...
      variants: [{
          ...
          getUrlsToPrerender: (function (param) {
              return Belt_Array.concatMany([
                          [
                            "/",
                            "blog"
                          ],
                          Belt_Array.map(Curry._1(param.getAll, "blog"), (function (slug) {
                                  return "/blog/" + slug;
                                })),
                          ["404.html"]
                        ]);
...
var Css = __webpack_require__(/*! bs-css-emotion/src/Css.bs.js */ "./node_modules/bs-css-emotion/src/Css.bs.js");
var $$Date = __webpack_require__(/*! ../utils/Date.bs.js */ "./src/utils/Date.bs.js");
var Curry = __webpack_require__(/*! bs-platform/lib/js/curry.js */ "./node_modules/bs-platform/lib/js/curry.js");
var Pages = __webpack_require__(/*! rescript-pages/src/Pages.bs.js */ "./node_modules/rescript-pages/src/Pages.bs.js");
var Theme = __webpack_require__(/*! ../shared/Theme.bs.js */ "./src/shared/Theme.bs.js");
var React = __webpack_require__(/*! react */ "react");
var BeOpWidget = __webpack_require__(/*! ../shared/BeOpWidget.bs.js */ "./src/shared/BeOpWidget.bs.js");
var Belt_Option = __webpack_require__(/*! bs-platform/lib/js/belt_Option.js */ "./node_modules/bs-platform/lib/js/belt_Option.js");
var ErrorIndicator = __webpack_require__(/*! ../shared/ErrorIndicator.bs.js */ "./src/shared/ErrorIndicator.bs.js");
var ActivityIndicator = __webpack_require__(/*! ../shared/ActivityIndicator.bs.js */ "./src/shared/ActivityIndicator.bs.js");

var container = Curry._1(Css.style, {
      hd: Css.maxWidth(Css.px(600)),
      tl: {
        hd: Css.padding2(Css.zero, Css.px(10)),
        tl: {
          hd: Css.margin2(Css.px(20), Css.auto),
          tl: {
...
var body = Curry._1(Css.style, {
      ...
      tl: {
        ...
        tl: {
          hd: Css.selector("a", {
                hd: Css.color(Css.hex("135EFF")),
                tl: {
                  hd: Css.hover({
                        hd: Css.color(Css.hex("13A3FF")),
                        tl: /* [] */0
                      }),
                  tl: /* [] */0
                }
...
Curry._2(Css.$$global, "pre", {
      ...
      tl: {
        hd: Css.backgroundColor(Css.hex("F4F7F8")),
        tl: {
          hd: Css.overflowX(Css.auto),
          tl: {
            hd: Css.unsafe("WebkitOverflowScrolling", "touch"),
            tl: {
              hd: Css.fontSize(Css.px(16)),
              tl: {
                hd: Css.borderLeftWidth(Css.px(2)),
                tl: {
                  hd: Css.borderLeftColor(Css.hex(Theme.darkBody)),
                  tl: {
...
Curry._2(Css.$$global, "code", {
      hd: Css.fontFamily({
            NAME: "custom",
            VAL: Theme.codeFontFamily
          }),
      tl: {
        hd: Css.fontSize(Css.em(0.85)),
        tl: {
          hd: Css.lineHeight({
                NAME: "abs",
                VAL: 1
...
Curry._2(Css.$$global, ".hljs-keyword", {
      hd: Css.color(Css.hex("DA6BB5")),
      tl: /* [] */0
    });

Curry._2(Css.$$global, ".hljs-constructor", {
      hd: Css.color(Css.hex("DD792B")),
      tl: /* [] */0
    });

Curry._2(Css.$$global, ".hljs-identifier", {
      hd: Css.color(Css.hex("1E9EA7")),
      tl: /* [] */0
    });

Curry._2(Css.$$global, ".hljs-module-identifier", {
      hd: Css.color(Css.hex("C84682")),
      tl: /* [] */0
    });

Curry._2(Css.$$global, ".hljs-string", {
      hd: Css.color(Css.hex("3BA1C8")),
      tl: /* [] */0
    });

Curry._2(Css.$$global, ".hljs-comment", {
      hd: Css.color(Css.hex("aaa")),
      tl: /* [] */0
    });

Curry._2(Css.$$global, ".hljs-operator", {
      hd: Css.color(Css.hex("DA6BB5")),
      tl: /* [] */0
    });

Curry._2(Css.$$global, ".hljs-attribute", {
      hd: Css.color(Css.hex("4CB877")),
      tl: /* [] */0
    });

Curry._2(Css.$$global, "table", {
      hd: Css.width(Css.pct(100)),
      tl: {
...
Curry._2(Css.$$global, "table thead th", {
      hd: Css.backgroundColor(Css.hex(Theme.lightBody)),
      tl: {
        hd: Css.padding2(Css.px(10), Css.zero),
        tl: /* [] */0
      }
    });

Curry._2(Css.$$global, "blockquote", {
      hd: Css.opacity(0.6),
      tl: {
        hd: Css.borderLeft(Css.px(4), Css.solid, Css.hex(Theme.darkBody)),
        tl: {
          hd: Css.margin(Css.zero),
          tl: {
            hd: Css.padding2(Css.zero, Css.px(20)),
            tl: /* [] */0
          }
        }
      }
...
function BlogPost(Props) {
  var slug = Props.slug;
  var post = Pages.useItem("blog", slug);
  var tmp;
  if (typeof post === "number") {
    tmp = React.createElement(ActivityIndicator.make, {});
  } else {
    var post$1 = post._0;
    if (post$1.TAG) {
      tmp = React.createElement(ErrorIndicator.make, {});
      ...
      tmp = React.createElement(React.Fragment, undefined, React.createElement(Pages.Head.make, {
                children: React.createElement("title", undefined, post$2.title)
                ...
                className: container
                    ...
                    className: date
                  }, Belt_Option.getWithDefault(Belt_Option.map(Belt_Option.map(Belt_Option.map(post$2.date, (function (prim) {
                                      return new Date(prim);
                                    })), $$Date.getFormattedString), (function (prim) {
                              return prim;
                  ...
                  }), React.createElement(BeOpWidget.make, {})));
    }
  }
...
var link = Curry._1(Css.style, {
      ...
      tl: {
        ...
        tl: {
          hd: Css.color(Css.hex(Theme.darkBody)),
          tl: {
...
function BlogPostList(Props) {
  var list = Pages.useCollection(undefined, undefined, "blog");
  var tmp;
  if (typeof list === "number") {
    tmp = React.createElement(ActivityIndicator.make, {});
  } else {
    var match = list._0;
    tmp = match.TAG ? React.createElement(ErrorIndicator.make, {}) : React.createElement(React.Fragment, undefined, React.createElement(Pages.Head.make, {
                children: React.createElement("title", undefined, "Blog")
              }), React.createElement("div", {
                className: container
              }, Belt_Array.map(match._0.items, (function (item) {
                      return React.createElement(Pages.Link.make, {
                                  href: "/blog/" + (item.slug + "/"),
                                  className: link,
                                  children: React.createElement(React.Fragment, undefined, React.createElement("div", {
                                            className: date
                                          }, Belt_Option.getWithDefault(Belt_Option.map(Belt_Option.map(Belt_Option.map(item.date, (function (prim) {
                                                              return new Date(prim);
                                                            })), $$Date.getFormattedString), (function (prim) {
                                                      return prim;
                                                    })), null)), React.createElement("div", {
...
var Theme = __webpack_require__(/*! ../shared/Theme.bs.js */ "./src/shared/Theme.bs.js");
var React = __webpack_require__(/*! react */ "react");
var Heading = __webpack_require__(/*! ../shared/Heading.bs.js */ "./src/shared/Heading.bs.js");
var CardList = __webpack_require__(/*! ../shared/CardList.bs.js */ "./src/shared/CardList.bs.js");
var TalkList = __webpack_require__(/*! ../shared/TalkList.bs.js */ "./src/shared/TalkList.bs.js");

var container = Curry._1(Css.style, {
      hd: Css.padding2(Css.px(50), Css.px(10)),
      tl: {
        hd: Css.display(Css.flexBox),
        tl: {
...
var column = Curry._1(Css.style, {
      ...
      tl: {
        hd: Css.width(Css.pct(10)),
        tl: {
          hd: Css.padding3(Css.zero, Css.px(10), Css.px(10)),
          tl: {
            hd: Css.media("(max-width: 620px)", {
      ...
      tl: {
        ...
        tl: {
          ...
          tl: {
            ...
            tl: {
              hd: Css.paddingBottom(Css.pct(100)),
              tl: {
                hd: Css.backgroundImage(Css.url("https://avatars.githubusercontent.com/bloodyowl?size=200")),
                tl: {
...
var hi = Curry._1(Css.style, {
      hd: Css.fontSize(Css.vw(12.0)),
      tl: {
        hd: Css.lineHeight({
              NAME: "abs",
              VAL: 0.5
        ...
        tl: {
          hd: Css.marginBottom(Css.vw(10.0)),
          tl: {
            hd: Css.transform(Css.translateX(Css.vw(-1.0))),
            tl: {
              hd: Css.fontWeight(Css.bold),
              tl: /* [] */0
            }
...
function Home(Props) {
  return React.createElement(React.Fragment, undefined, React.createElement(Pages.Head.make, {
                  children: React.createElement("title", undefined, "Matthias Le Brun")
                }), React.createElement("div", {
                  className: container
                }, React.createElement("div", {
                      className: column
                      ...
                      className: main
                          ...
                          text: "Things I work with"
                        }), React.createElement(CardList.make, {
                          cards: [
                            [
                              "rescript",
                              {
...
/***/ "./src/shared/ActivityIndicator.bs.js":
/*!********************************************!*\
  !*** ./src/shared/ActivityIndicator.bs.js ***!
  \********************************************/
/*! no static exports found */
...
var Css = __webpack_require__(/*! bs-css-emotion/src/Css.bs.js */ "./node_modules/bs-css-emotion/src/Css.bs.js");
var Curry = __webpack_require__(/*! bs-platform/lib/js/curry.js */ "./node_modules/bs-platform/lib/js/curry.js");
var Theme = __webpack_require__(/*! ./Theme.bs.js */ "./src/shared/Theme.bs.js");
var React = __webpack_require__(/*! react */ "react");
...
function ActivityIndicator(Props) {
  ...
  var color = colorOpt !== undefined ? colorOpt : "#" + Theme.darkBody;
  var size = sizeOpt !== undefined ? sizeOpt : 32;
  var strokeWidth = strokeWidthOpt !== undefined ? strokeWidthOpt : 2;
  return React.createElement("div", {
              className: container
          ...
          tl: {
            ...
            tl: {
              ...
              tl: {
                hd: Css.color(Css.hex(Theme.darkBody)),
                tl: {
                  hd: Css.padding4(Css.px(20), Css.px(20), Css.px(20), Css.zero),
                  tl: {
                    hd: Css.unsafe("scrollSnapAlign", "start"),
                    tl: /* [] */0
                  }
                }
              }
...
var image = Curry._1(Css.style, {
      hd: Css.width(Css.px(128)),
      tl: {
        hd: Css.height(Css.px(128)),
        tl: {
          hd: Css.borderRadius(Css.px(25)),
          tl: {
            hd: Css.transitionDuration(300),
            tl: {
              hd: Css.transitionTimingFunction("easeOut"),
              tl: {
                hd: Css.boxShadow(Css_Legacy_Core.Shadow.box(undefined, Css.px(5), Css.px(10), undefined, undefined, Css.rgba(0, 0, 0, {
                              NAME: "num",
                              VAL: 0.1
                            }))),
                tl: {
                  hd: Css.transitionProperty("transform, box-shadow"),
                  tl: {
                    hd: Css.hover({
                          hd: Css.transforms({
                                hd: Css.scale(0.96, 0.96),
                                tl: /* [] */0
                              }),
                          tl: {
                            hd: Css.boxShadow(Css_Legacy_Core.Shadow.box(undefined, Css.px(3), Css.px(7), undefined, undefined, Css.rgba(0, 0, 0, {
                                          NAME: "num",
                                          VAL: 0.3
                                        }))),
                            tl: /* [] */0
...
function CardList$Card(Props) {
  var card = Props.card;
  var contents = React.createElement(React.Fragment, undefined, React.createElement("img", {
            className: image,
            alt: "",
            src: card.image
          }), React.createElement("div", {
          ...
          tl: {
            ...
            tl: {
              ...
              tl: {
                hd: Css.unsafe("WebkitOverflowScrolling", "touch"),
                tl: {
                  hd: Css.unsafe("scrollSnapType", "x mandatory"),
                  tl: /* [] */0
                }
              }
            }
...
function CardList(Props) {
  ...
  return React.createElement("div", {
              className: root
                ...
                }, Belt_Array.map(cards, (function (param) {
                        return React.createElement(CardList$Card, {
                                    card: param[1],
                                    key: param[0]
                                  });
                      }))));
...
/***/ "./src/shared/ErrorIndicator.bs.js":
/*!*****************************************!*\
  !*** ./src/shared/ErrorIndicator.bs.js ***!
  \*****************************************/
/*! no static exports found */
...
var container = Curry._1(Css.style, {
      hd: Css.backgroundColor(Css.hex(Theme.darkBody)),
      tl: {
...
function Footer(Props) {
  return React.createElement("div", {
              className: container
            }, "Copyright 2020 - Matthias Le Brun");
}
...
var heading = Curry._1(Css.style, {
      hd: Css.padding4(Css.px(20), Css.px(20), Css.px(23), Css.zero),
      tl: {
        hd: Css.display(Css.flexBox),
        tl: {
          hd: Css.flexDirection(Css.row),
...
var name = Curry._1(Css.style, {
      hd: Css.fontWeight(Css.bold),
      tl: {
        hd: Css.marginRight(Css.px(10)),
        tl: {
          hd: Css.whiteSpace(Css.nowrap),
          tl: /* [] */0
        }
      }
    });
        ...
        tl: {
          ...
          tl: {
            hd: Css.media("(max-width: 620px)", {
                  hd: Css.flexGrow(1),
                  tl: {
                    hd: Css.backgroundColor(Css.hex("D4E1E6")),
                    tl: /* [] */0
                  }
                }),
            tl: /* [] */0
...
var link = Curry._1(Css.style, {
      hd: Css.padding3(Css.px(20), Css.px(20), Css.px(23)),
      tl: {
        hd: Css.flexShrink(0.0),
        tl: {
          hd: Css.textDecoration(Css.none),
          tl: {
            ...
            tl: {
              ...
              tl: {
                hd: Css.media("(max-width: 620px)", {
                      hd: Css.flexBasis(Css.pct(33.333)),
                      tl: {
                        hd: Css.padding3(Css.px(10), Css.px(20), Css.px(13)),
                        tl: /* [] */0
                      }
                    }),
                tl: /* [] */0
...
var activeLink = Curry._1(Css.style, {
      hd: Css.fontWeight(Css.bold),
      tl: /* [] */0
    });
...
function Header(Props) {
  return React.createElement("div", {
              className: container
                  ...
                  href: "/",
                  className: left,
                  children: React.createElement(React.Fragment, undefined, React.createElement("img", {
                            className: logo,
                            alt: "",
                            height: "32",
                            ...
                            role: "heading"
                                ...
                                className: name
                              }, "Matthias Le Brun"), React.createElement("div", undefined, "@bloodyowl")))
                }), React.createElement("div", {
...
var title = Curry._1(Css.style, {
      hd: Css.margin2(Css.px(20), Css.zero),
      tl: {
        hd: Css.fontSize(Css.px(42)),
        tl: {
          hd: Css.fontWeight(Css.bold),
          tl: /* [] */0
        }
...
function TalkList(Props) {
  ...
  return React.createElement("div", {
              className: container
                  ...
                  className: list,
                  role: "list"
                }, Belt_Array.map(talks, (function (param) {
                        var talk = param[1];
                        return React.createElement("div", {
                                    key: param[0],
                                    className: item,
                                    role: "listitem"
                                        ...
                                        href: talk.url
                                            ...
                                            className: date
                                          }, talk.date), React.createElement("div", {
                                            className: name
                                          }, talk.name), React.createElement("div", {
...
var lightBody = "E4EBEE";

var darkBody = "46515B";

var defaultTextFontFamily = "HelveticaNowDisplay, \"Helvetica Neue\", Helvetica, Arial, sans-serif";

var codeFontFamily = "SFMono-Regular, Consolas, Liberation Mono, Menlo, Courier, monospace";

exports.lightBody = lightBody;
exports.darkBody = darkBody;
exports.defaultTextFontFamily = defaultTextFontFamily;
...
Curry._1(Css.$$global, Css.fontFace("HelveticaNowDisplay", {
          hd: Css.url("/public/assets/webfonts/regular.woff2"),
          tl: {
            hd: Css.url("/public/assets/webfonts/regular.woff"),
            tl: /* [] */0
          }
        }, Css.normal, {
          NAME: "num",
...
Curry._1(Css.$$global, Css.fontFace("HelveticaNowDisplay", {
          hd: Css.url("/public/assets/webfonts/bold.woff2"),
          tl: {
            hd: Css.url("/public/assets/webfonts/bold.woff"),
            tl: /* [] */0
          }
        }, Css.normal, {
          NAME: "num",
      ...
      tl: {
        ...
        tl: {
          ...
          tl: {
            hd: Css.fontFamily({
                  NAME: "custom",
                  VAL: Theme.defaultTextFontFamily
                }),
            tl: {
              hd: Css.display(Css.flexBox),
              tl: {
...
Curry._2(Css.$$global, "html", {
      ...
      tl: {
        ...
        tl: {
          ...
          tl: {
            hd: Css.unsafe("WebkitFontSmoothing", "antialiased"),
            tl: {
              hd: Css.unsafe("WebkitTextSizeAdjust", "100%"),
              tl: /* [] */0
            }
          }
        }
...
function getFormattedString(date) {
  return String(date.getUTCFullYear() | 0) + ("/" + (padLeft(String((date.getUTCMonth() | 0) + 1 | 0)) + ("/" + padLeft(String(date.getUTCDate() | 0)))));
}
